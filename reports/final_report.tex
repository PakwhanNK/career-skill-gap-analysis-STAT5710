...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{target_vs_non_target_counts.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{top_target_schools.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{school_target_non_target_percentages.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{target_major_mix.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{target_skill_shares_2024_2025.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{skill_pca_target_vs_non_target.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{skill_kmeans_elbow.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{skill_cluster_target_rates.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{model_comparison_auc.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{top_role_percentages_2024_2025.pdf}
